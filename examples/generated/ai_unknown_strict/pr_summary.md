...
- Profile: `ai_or_unknown_provenance`
- Evidence requirement: `high`
- Provenance: `unknown` (confidence: medium)
...
- [P2] Address 2 finding(s) in category 'path_traversal' and add regression checks. | owner role: Backend Engineering Lead | follow-up: Next sprint
...
## 7. Evidence Appendix
- Generated at: 2026-02-23T19:44:22.911773+00:00
- Tool versions: n/a
